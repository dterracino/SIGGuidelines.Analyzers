...
namespace SIGGuidelines.Analyzers.Tests.Metrics
{
    ...
    public class UnitSizeTest
    {
        ...
        {
            SizeOf(MethodWithBody(string.Empty)).Should().Be(0);
        ...
        private static long SizeOf(SyntaxNode method) => new UnitSizeMetric(method).Size - 2; // -2 for added opening and closing brackets ({ and }).
